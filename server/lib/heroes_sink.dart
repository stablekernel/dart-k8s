...
class HeroesSink extends RequestSink {
  ...
  HeroesSink(ApplicationConfiguration appConfig) : super(appConfig) {
    logger.onRecord.listen((rec) => print("$rec ${rec.error ?? ""} ${rec.stackTrace ?? ""}"));

    var options = new HeroesConfiguration(appConfig.configurationFilePath);
...
class HeroesConfiguration extends ConfigurationItem {
  HeroesConfiguration(String fileName) : super.fromFile(fileName);
