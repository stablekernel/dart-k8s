...
class TestApplication {
  Application<HeroesSink> application;
  HeroesSink get sink => application.mainIsolateSink;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [HeroesSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [HeroesSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<HeroesSink>();
